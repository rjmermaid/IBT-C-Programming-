    ...
    public partial class frmMain : Form
    {
        ...
        private void dealButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                pictureBox1.ImageLocation = @"Resources/" + card1.Image;
                pictureBox1.SizeMode = PictureBoxSizeMode.AutoSize;

                pictureBox2.ImageLocation = @"Resources/" + card2.Image; 
                ...
                pictureBox4.ImageLocation = @"Resources/" + card3.Image;
        ...
        {
            // picturebox.Image = Properties.Resources.b1fv;
        ...
        private void hitMeButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    p3.ImageLocation = @"Resources/" + card.Image;
        ...
        private void PlayerStop_Click(object sender, EventArgs e)
        {
            if (playercardSum == 0)
            {
                resultLabel.Text = "Click the Start button...";
            ...
            while (bankercardSum <= 16)
            {
                ...
                p4.ImageLocation = @"Resources/" + card.Image;
            ...
            {
                resultLabel.Text = String.Format
                    ("The sum of banker cards is: {0}, he loses!", bankercardSum);
                MessageBox.Show("You win!", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                resetGame();
            }
